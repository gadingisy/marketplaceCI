					...
					<div class="col-xl-12 col-lg-12 col-md-12 mb-4">
						<div class="card shadow mb-4">
							<div class="card-header py-3">
								<h6 class="m-0 font-weight-bold text-danger">Ganti Iklan 2</h6>
							</div>
							<div class="card-body">
									...
									<div class="col-md-12">
										...
										<form method="post"
											...
											<div class="form-group">
												...
												<input type="file" class="form-control" name="gambar_iklan2">

											</div>
											<div class="form-group">
												<label for="nama_penjual">Alt Gambar Iklan 2</label>
												<input type="text" class="form-control" name="alt_iklan2" id="alt_iklan2">
												<small class="form-text text-danger"></small>
											</div>

											<div class="form-group">
											<input type="hidden" class="form-control" name="tipe_iklan" value="iklan2">
											</div>
						...
						<div class="card shadow mb-4">
							...
							<div class="card-body">
								<div class="table-responsive">
									...
									<tr>
										<td><img src="<?=base_url("./assets/upload/images/".$data->gambar_iklan2)?>" width="100px" class="mb-3"></td>
										<td><?= $data->alt_iklan2 ?></td>
										<?php if ($data->published != 'publish'){ ?>
										<td><a href="<?= base_url(); ?>Manajemenwebsite/publishiklan2/<?= $data->id_iklan2 ?>" class='btn btn-sm btn-success mb-2'><i class="fas fa-check mr-2"></i>Publish</a></td>
										
										<?php } else {?>
										<td><a href="<?= base_url(); ?>Manajemenwebsite/dontpublishiklan2/<?= $data->id_iklan2 ?>" class='btn btn-sm btn-warning mb-2'><i class="fas fa-times mr-2"></i>Batal</a></td>

										<?php }?>
										<td>
										<a href="<?= base_url(); ?>Manajemenwebsite/hapusiklan2/<?= $data->id_iklan2 ?>" class='btn btn-sm btn-danger' onclick="return confirm('Yakin?');" ><i class="fas fa-times-circle mr-2"></i>Hapus</a>
										</td>
									</tr>
										<?php endforeach; ?>
										</tbody>
