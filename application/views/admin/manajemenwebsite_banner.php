					...
					<div class="col-xl-12 col-lg-12 col-md-12 mb-4">
						<div class="card shadow mb-4">
							<div class="card-header py-3">
								<h6 class="m-0 font-weight-bold text-danger">Ganti Banner</h6>
							</div>
							<div class="card-body">
									...
									<div class="col-md-12">
										...
										<form method="post"
											...
											<div class="form-group">
												<label for="foto_ktp">Banner</label>
												<input type="file" class="form-control" name="hero_iklan">
						...
						<div class="card shadow mb-4">
							...
							<div class="card-body">
								<div class="table-responsive">
									...
									<tr>
										<td><img src="<?=base_url("./assets/upload/images/".$data->hero_iklan)?>" width="100px" class="mb-3"></td>
										<td><?= $data->alt_hero ?></td>
										<?php if ($data->published != 'publish'){ ?>
										<td><a href="<?= base_url(); ?>Manajemenwebsite/publishbanner/<?= $data->id_iklan ?>" class='btn btn-sm btn-success mb-2'><i class="fas fa-check mr-2"></i>Publish</a></td>
										
										<?php } else {?>
										<td><a href="<?= base_url(); ?>Manajemenwebsite/dontpublishbanner/<?= $data->id_iklan ?>" class='btn btn-sm btn-warning mb-2'><i class="fas fa-times mr-2"></i>Batal</a></td>
