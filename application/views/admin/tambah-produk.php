...
$(document).ready(function() {
    ...
    $(add_button).click(function(e){ //on add input button click
        ...
        if(x < max_fields){ //max input box allowed
            ...
            $(wrapper).append('<div><input type="text" name="mytext[]" placeholder="Deskripsi Produk"><a href="#" class="ml-2 mb-2 btn btn-primary remove_field">Hapus</a></div>'); //add input box
        }
    });
