		...
		<div class="col-md-8 col-xs-8">
			...
			<div class="card">
				...
				<div class="card-body">
					...
					<form method="post" action="<?php echo base_url('Overview/process'); ?>"
						...
						<div class="form-group">
							...
							<textarea type="text" class="form-control" name="deskripsi_produk" id="editor"
						...
						<div class="form-group">
							...
							<select name="penjual" class="form-control" required>
								...
								<option value="<?= $data->id_penjual ?>"
									<?= set_select('penjual','$data->nama_penjual'); ?>><?=$data->nama_penjual?>
								</option>
								<?php } ?>
							</select>
						</div>
						...
						<div class="form-group">
							...
							<span class="badge badge-secondary mt-2">Isikan juga satuan barang, misal : 200gr, 1kg, 1ton
								dan lain-lain.</span>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="ukuran_produk"
								value="<?=$row->ukuran_produk?>">

						</div>
						<div class="form-group">
							<label for="harga_produk">Harga Produk</label>
							<input type="text" id="rupiah" class="form-control" name="harga_produk"
						...
						<div class="form-group">
							...
							<input type="file" class="form-control" name="thumb_produk1"
								value="<?=$row->thumb_produk1?>">

						</div>

						<div class="form-group">
							<label for="gambar_produk">Thumb Produk 2</label>
							<input type="file" class="form-control" name="thumb_produk2"
								value="<?=$row->thumb_produk2?>">

						</div>

						<div class="form-group">
							<label for="gambar_produk">Thumb Produk 3 </label>
							<input type="file" class="form-control" name="thumb_produk3"
								value="<?=$row->thumb_produk3?>">
						...
						<button type="submit" name="<?=$page?>" class="btn btn-danger btn-lg float-right"><i
